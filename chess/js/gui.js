...
function AddGUIPiece(sq,pce) {
	if(pce){
		...
		imageString = "<image draggable=false  src=\"" + pieceFileName + "\" class=\"Piece clickElement " + rankName + " " + fileName + "\"/>";
	...
	for(rankIter = RANKS.RANK_8; rankIter >= RANKS.RANK_1; rankIter--) {
		...
		for(fileIter = FILES.FILE_A; fileIter <= FILES.FILE_H; fileIter++) {
			...
			if(GameController.BoardFlipped == false){
				switch (true) {
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_A) : coords = 'a';coords_class = 'cletter'; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_B) : coords = 'b';coords_class = 'cletter cletter-light'; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_C) : coords = 'c';coords_class = 'cletter'; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_D) : coords = 'd';coords_class = 'cletter cletter-light'; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_E) : coords = 'e';coords_class = 'cletter'; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_F) : coords = 'f';coords_class = 'cletter cletter-light'; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_G) : coords = 'g';coords_class = 'cletter'; break;

					case (rankIter == RANKS.RANK_2 && fileIter == FILES.FILE_H) : coords = '2';coords_class = 'cnumber'; break;
					case (rankIter == RANKS.RANK_3 && fileIter == FILES.FILE_H) : coords = '3';coords_class = 'cnumber cnumber-light'; break;
					case (rankIter == RANKS.RANK_4 && fileIter == FILES.FILE_H) : coords = '4';coords_class = 'cnumber'; break;
					case (rankIter == RANKS.RANK_5 && fileIter == FILES.FILE_H) : coords = '5';coords_class = 'cnumber cnumber-light'; break;
					case (rankIter == RANKS.RANK_6 && fileIter == FILES.FILE_H) : coords = '6';coords_class = 'cnumber'; break;
					case (rankIter == RANKS.RANK_7 && fileIter == FILES.FILE_H) : coords = '7';coords_class = 'cnumber cnumber-light'; break;
					case (rankIter == RANKS.RANK_8 && fileIter == FILES.FILE_H) : coords = '8';coords_class = 'cnumber'; break;
				...
				switch (true) {
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_A) : coords = 'h';coords_class = 'cletter '; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_B) : coords = 'g';coords_class = 'cletter cletter-light'; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_C) : coords = 'f';coords_class = 'cletter '; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_D) : coords = 'e';coords_class = 'cletter cletter-light'; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_E) : coords = 'd';coords_class = 'cletter '; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_F) : coords = 'c';coords_class = 'cletter cletter-light'; break;
					case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_G) : coords = 'b';coords_class = 'cletter '; break;

					case (rankIter == RANKS.RANK_2 && fileIter == FILES.FILE_H) : coords = '7';coords_class = 'cnumber'; break;
					case (rankIter == RANKS.RANK_3 && fileIter == FILES.FILE_H) : coords = '6';coords_class = 'cnumber cnumber-light'; break;
					case (rankIter == RANKS.RANK_4 && fileIter == FILES.FILE_H) : coords = '5';coords_class = 'cnumber'; break;
					case (rankIter == RANKS.RANK_5 && fileIter == FILES.FILE_H) : coords = '4';coords_class = 'cnumber cnumber-light'; break;
					case (rankIter == RANKS.RANK_6 && fileIter == FILES.FILE_H) : coords = '3';coords_class = 'cnumber'; break;
					case (rankIter == RANKS.RANK_7 && fileIter == FILES.FILE_H) : coords = '2';coords_class = 'cnumber cnumber-light'; break;
					case (rankIter == RANKS.RANK_8 && fileIter == FILES.FILE_H) : coords = '1';coords_class = 'cnumber'; break;
					//	case (rankIter == RANKS.RANK_1 && fileIter == FILES.FILE_A) : coords = 'a'; break;
...
function SetInitialBoardPieces() {
	...
	for( sq = 0; sq < 64; ++sq) {
		...
		if(pce>=PIECES.wP && pce<=PIECES.bK) {
			...
			pieceFileName = "images/" + SideChar[PieceCol[pce]] + PceChar[pce].toUpperCase() + ".png";
			imageString = "<image draggable=false src=\"" + pieceFileName + "\" class=\"Piece " + rankName + " " + fileName + "\"/>";
